 ...
 *-----------------------------------------------------------------------------
 *
 * $Id: protocol.h,v 1.3 1999/10/12 13:01:15 cphipps Exp $
 *
...
typedef struct {
  ...
  enum packet_type_e type; // Type of packet
...
static inline void GetTicSwap(ticcmd_t* dst, const ticcmd_t* src)
{
  *dst = *src;
